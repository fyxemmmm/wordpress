var rand1=Math.floor(Math.random()*30+0);quotes=new Array
quotes[0]='得到了不该得到的，就会失去不该失去的。'
quotes[1]='所谓结婚，就是把错误延续一生。《银魂》'
...
quotes[15]='我的愿望是，将一位少女拥入怀中，而拯救世界，只不过是顺带罢了。'
...
quotes[27]='来者勿拒，去者不追。'
quotes[28]='自由不是无法无天而是按照自己的规则活下去。'
quotes[29]='有时候，我们明明原谅了那个人，却无法真正快乐起来。那是因为，你忘了原谅自己。'
var tmp1 = Math.random()*10
if(tmp1 < 7){
